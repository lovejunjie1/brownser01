class RedBlackStyleSheet():
    ...
    def QTabWidget(self,kw='a'):
        ...
        if kw == 'a':
            tabWidgetStyle = ('QTabWidget::pane             { border-top: 0px solid #C2C7CB;} '
                              ...
                              'QTabBar::tab::disabled       { background: transparent;color:transparent;}'
                              'QTabBar::tab:only-one        { margin: 0;} ')
        elif kw == 'b':
            tabWidgetStyle = ('QTabWidget::pane             { border-top: 0px solid #C2C7CB;} '
                              'QTabWidget::tab-bar          { left: 0px; }'
                              'QTabBar::tab                 { color:rgb(150,150,150);background:transparent; border: 0px solid #C4C4C3;  min-height: 18px; min-width: 58px; border-bottom-color: #C2C7CB;border-top-left-radius: 8px;  border-top-right-radius: 8px;   padding: 0px; }'
                              'QTabBar::tab:hover           { color:rgb(255,255,255);background: transparent;  border: 1px solid #C4C4C3;border-right-color: transparent; padding: 0px; }'
                              'QTabBar::tab:selected        { background: rgb(109,109,109);  border-color: #9B9B9B; border-bottom-color: rgb(109,109,109);border-right-color: #C2C7CB;margin-left: 0px; margin-right: 0px;}  '
                              'QTabBar::tab:!selected       { margin-top: 0px; }'
                              'QTabBar::tab:first:hover     { color:rgb(130,255,202);background:transparent;margin-left: 0;border: 1px solid rgb(130,255,202);border-bottom-color: rgb(109,109,109);} '
                              'QTabBar::tab:first:selected  { background:rgb(109,109,109);margin-left: 0;} '
                              'QTabBar::tab:last:hover      { color:rgb(253,202,137);background:transparent;margin-right: 0;border: 1px solid rgb(253,202,137);border-bottom-color: rgb(109,109,109);} '
                              'QTabBar::tab:last:selected   { background:rgb(109,109,109);margin-right: 0;} '
                              'QTabBar::tab::disabled       { background: transparent;color:transparent;}'
                              'QTabBar::tab:only-one        { margin: 0;} ')
        elif kw == 'c':
            tabWidgetStyle = ('QTabWidget::pane             { border-top: 0px solid #C2C7CB;} '
                              'QTabWidget::tab-bar          { left: 0px; }'
                              'QTabBar::tab                 { color:rgb(150,150,150);background:rgb(109,109,109); border: 0px solid #C4C4C3;  min-height: 18px; min-width: 58px;height: 18px; width: 58px; border-bottom-color: #C2C7CB;border-radius: 8px;padding: 0px; }'
                              'QTabBar::tab:hover           { color:rgb(255,255,255);  border: 1px solid #C4C4C3;border-right-color: transparent; padding: 0px; }'
                              'QTabBar::tab:selected        { background: rgb(89,89,89);  border-color: #9B9B9B; border-bottom-color: rgb(109,109,109);border-right-color: #C2C7CB;margin-left: 0px; margin-right: 0px;}  '
                              'QTabBar::tab:!selected       { margin-top: 0px; }'
                              'QTabBar::tab:first           { border-bottom-left-radius: 8px;border-bottom-right-radius: 0px;} '
                              'QTabBar::tab:first:hover     { color:rgb(130,255,202);margin-left: 0;border: 1px solid rgb(130,255,202);border-bottom-color: rgb(109,109,109);} '
                              'QTabBar::tab:first:selected  { background:rgb(89,89,89);margin-left: 0;} '
                              'QTabBar::tab:last            { border-bottom-left-radius: 0px;border-bottom-right-radius: 0px;} '
                              'QTabBar::tab:last:hover      { color:rgb(253,202,137);background:transparent;margin-right: 0;border: 1px solid rgb(253,202,137);border-bottom-color: rgb(109,109,109);} '
                              'QTabBar::tab:last:selected   { background:rgb(89,89,89);margin-right: 0;} '
                              'QTabBar::tab::disabled       { background: transparent;color:transparent;}'
                              'QTabBar::tab:only-one        { margin: 0;} ')
    ...
    def QComboBox(self):
        comboBoxStyle = ('QComboBox{border:1px solid gray;border-radius:8px;padding:4px18px1px3px;min-width:6em;}'
