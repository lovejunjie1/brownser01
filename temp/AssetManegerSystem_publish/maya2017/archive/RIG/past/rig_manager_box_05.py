...
class userLoginUI(QtGui.QMainWindow):
    ...
    def CreateUI(self):
        ...
        dir(Mstyle)
        #cha sel
        mainGrp=QtGui.QGroupBox('register',self)
        ...
        cancelBtn.setGeometry(90,85,0,0)
        cancelBtn.setFixedHeight(20)
        cancelBtn.setFixedWidth(80)
        cancelBtn.setStyleSheet(Mstyle.pushBtnStyle(kw='b'))
        
        userLE=QtGui.QLineEdit(mainGrp)
        userLE.setText('user')
        userLE.setGeometry(10,20,0,0)
        userLE.setFixedHeight(20)
        userLE.setFixedWidth(self.x*0.8)
        userLE.setStyleSheet(Mstyle.LineEditStyle(fontSize='15px'))
        
        
        passwordLE=QtGui.QLineEdit(mainGrp)
        passwordLE.setText('password')
        passwordLE.setGeometry(10,50,0,0)
        passwordLE.setFixedHeight(20)
        passwordLE.setFixedWidth(self.x*0.8)
        passwordLE.setStyleSheet(Mstyle.LineEditStyle(fontSize='15px'))
