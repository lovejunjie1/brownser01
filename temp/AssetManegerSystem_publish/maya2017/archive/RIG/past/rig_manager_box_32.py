...
#from bin import docWriter_maya_reader
...
class RigManagerBoxUI(QtGui.QDialog ,MayaQWidgetDockableMixin, chooseIcon):
    ...
    def createTab(self):
        ...
        comEditBtn.clicked.connect(self.refreshList)
    ...
    def readNote(self):
        ...
        thewidget=writerReaderUI()  
        #thewidget.setParent(self)
        thewidget.move(0,0)        
    ...
    def refreshList(self):
        ...
        for f in folders:
            ...
            itm.setIcon(icn)
            itm.setToolTip(f)
            itm.setBackground(QtGui.QBrush(QtGui.QColor(colorArray[cn][0],colorArray[cn][1],colorArray[cn][2])))
