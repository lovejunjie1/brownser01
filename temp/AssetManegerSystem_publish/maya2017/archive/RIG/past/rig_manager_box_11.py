...
class RigManagerBoxUI(MayaQWidgetDockableMixin, QtGui.QDialog ,chooseIcon):
    ...
    def createSplitter(self):
        ...
        self.treeWid.setParent(self.splitter)
        self.treeWid.setVisible(self.isTree)
    ...
    def createTab(self):
        ...
        processWid.setAttribute(Qt.WA_DeleteOnClose)
        '''
    ...
    def createGeneralPage(self):
        ...
        lab2.setToolTip('statemessage')
        stateGVB.addWidget(lab2) 
        
        lab2=QtGui.QPushButton('there is a editText here ',msgWid)
        lab2.setToolTip('actionbutton')
        stateGVB.addWidget(lab2) 
                    ...
                    if type(c)==QtGui.QGroupBox:
                        ...
                        if c.title()=='model':
                            ...
                            for cc in c.children():
                                if type(cc)!=QtGui.QVBoxLayout:
                                    if cc.toolTip()=='highDate':
                                        ...
                                        lDate=cc
                                    elif cc.toolTip()=='highUpdate':
                                        pass
                                    elif cc.toolTip()=='lowUpdate':
                                        pass
                            ...
                            if lFile:
                                ...
                                #lDate.setText(time.ctime(os.path.getmtime(lFile)))  
                                #print lFile  
                            else:
                                lDate.setText('')  
                                #hDate.setText(time.ctime(os.path.getmtime()))       
