class RedBlackStyleSheet():
    ...
    def mainWidgetStyle(self):
        mainWidgetStyle=('QWidget {background-color :'+self.bgColor+';border:0px solid '+self.fontBlack+';color:'+self.fontWhite+';}')
        return mainWidgetStyle
        
    def pushBtnStyle(self,kw='on',lang='e',bordRad='8px',bordWid='0px'):
        font=''
        btnStyle=''
        if lang == 'e':
            font='Verdana'
    ...
    def LineEditStyle(self,kw='a',lang='e',bordRad='8px',bordWid='0px',fontSize='10px'):
        LineEditStyle=''
        font=''
        fontStyle=''
        if lang == 'e':
        ...
        colorSet={
        'a' : ['rgb(220,220,220)',self.fontBlack,'rgb(100,100,100)','rgb(220,220,220)',self.fontBlack,'rgb(100,100,100)'],       
        ...
        if kw in colorSet.keys():
            data=colorSet[kw]
            LineEditStyle=('QLineEdit {font-family:'+font+';font-size:'+fontSize+';font-weight:None;font-style:'+fontStyle+';color:'+data[0]+';border:'+bordWid+' solid '+data[1]+';border-radius:'+bordRad+';background:'+data[2]+';}'
            'QLineEdit:hover {font-size:10px;font-weight:None;font-style:oblique;color:'+data[3]+';border:'+bordWid+' solid '+data[4]+';border-radius:'+bordRad+';background:'+data[5]+';}'
            
            )
        else:
            if kw=='d':
                LineEditStyle=('QLineEdit {font-family:'+font+';font-size:'+fontSize+';font-weight:None;font-style:'+fontStyle+';color:'+self.fontWhite+';border:'+bordWid+' solid transparent;border-top-right-radius: '+bordRad+'; border-top-left-radius: '+bordRad+';  border-bottom-left-radius: 0px;border-bottom-right-radius: 0px;background:transparent;}'
    ...
    def LabelStyle(self,kw='a',lang='e',bordRad='8px',bordWid='0px',fontSize='20px'):
        font=''
        fontStyle=''
        LabelStyle=''
        if lang == 'e':
            ...
            fontStyle='None'
        if kw=='a':
            LabelStyle=('QLabel {font-family:'+font+';font-size:'+fontSize+';font-weight:None;font-style:'+fontStyle+';border:0px solid '+self.fontBlack+';}')
        elif kw=='b':
            LabelStyle=('QLabel {background:transparent;font-family:'+font+';font-size:'+fontSize+';font-weight:None;font-style:'+fontStyle+';border:0px solid '+self.fontBlack+';}')
       
        
        return LabelStyle
        
    def GroupBoxStyle(self,kw='a'):
        #'qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 rgb(51,51,51),stop: 1.0 rgb(68,68,68))'
        QGroupBoxStyleA=''
        if kw=='a':
            QGroupBoxStyleA=('QGroupBox{background:qlineargradient(x1:0,y1:0,x2:0,y2:1,stop: 0 transparent,stop:0.8 rgb(55,55,55),stop:1 rgb(60,60,60));border:1px solid gray;border-radius:10px;margin-top:1ex;}'
                                'QGroupBox:title{subcontrol-origin:margin;subcontrol-position:top left;padding:0 3px;}')
        elif kw=='b':
            QGroupBoxStyleA=('QGroupBox{background:qlineargradient(x1:0,y1:0,x2:0,y2:1,stop: 0 transparent,stop:1 rgb(90,90,90));border:1px solid gray;border-radius:10px;margin-top:1ex;}'
    ...
    def SpinBoxStyle(self):
        ...
        spinBox=('QSpinBox {color:rgb(170,170,170);border:1px solid rgb(170,170,170);padding-right: 0px;border-width: 1;}' 
    ...
    def ListWidgetStyle(self,kw='a',lang='e',bordRad='16px',bordWid='0px',fontSize='9px'):
        QListWidgetStyleA=( 'QListWidget                        {color:'+self.fontWhite+';font-size:'+fontSize+';background:transparent;border-radius:'+bordRad+';border:'+bordWid+' solid gray;}'
    ...
    def TextEditStyle(self,kw='a',lang='e',bordRad='8px',bordWid='0px',useHover=False,fontSize='13px'):
        font=''
        fontStyle=''
        if lang == 'e':
            font='Verdana'
            ...
            fontStyle='None'
        dataTemp={
        'a':['rgb(220,220,220)','rgb(143,143,143)','transparent','rgb(220,220,220)','rgb(143,143,143)','transparent','rgb(200,200,200)'],
        'b':['rgb(220,220,220)','rgb(143,143,143)','rgb(58,58,58)','rgb(255,255,255)','rgb(143,143,143)','rgb(88,88,88)','rgb(200,200,200)'],
        'c':['rgb(220,220,220)','rgb(143,143,143)','qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 rgb(51,51,51),stop: 1.0 rgb(68,68,68))','rgb(220,220,220)','rgb(93,139,158)','rgb(68,68,68)','rgb(10,36,106)']
        
        
        }
        dt=dataTemp[kw]
        textStyle=('QTextEdit          {font-family:'+font+';font-size:'+fontSize+';font-weight:None;font-style:'+fontStyle+';border-radius:'+bordRad+';color:'+dt[0]+';border:'+bordWid+' solid '+dt[1]+';background: '+dt[2]+';selection-background-color:'+dt[-1]+'}'
                       'QTextEdit:hover    {border-radius:'+bordRad+';padding-top:-1px;padding-bottom:0px;padding-left:10px;padding-right:10px;color:'+dt[3]+';border:'+bordWid+' solid '+dt[4]+';background: '+dt[5]+';}')
    
 
        return textStyle
        
    def CheckBoxStyle(self):                            
        QCheckBoxStyleA=('QCheckBox {border-radius:2px;width: 13px;height: 13px;color:rgb(248,91,90);border:0px solid '+self.fontBlack+';'
                                    'font-family:Verdana;font-size:13px;}'
                                        'QCheckBox:hover{background: '+ self.lighterColor(self.bgColor)+';}'
                                      'QCheckBox::indicator {width: 13px;height: 13px;}'
                                      'QCheckBox::indicator:checked {backgroud:#5D8B9E}'
                                        ) 
        return QCheckBoxStyleA
        
    def SclAreaStyle(self):                    
        QSclAreaStyleA=('QScrollBar{background:'+ self.lighterColor(self.bgColor)+'; width:4px;border-radius:5px; }'
                                        'QScrollBar::handle{background:rgb(245,75,57); border-radius:5px; }'
                                        'QScrollBar::handle:hover{background:rgb(255,95,77);border-radius:5px; }'
                                        'QScrollBar::handle:pressed{background:rgb(205,53,43);}'
                                        'QScrollBar::sub-line{background:'+ self.lighterColor(self.bgColor)+';}'
    ...
    def radioBtnStyle(self,kw='a',lang='e',bordRad='5px',bordWid='1px'):
        font=''
        if lang == 'e':
            font='Verdana'
        elif lang == 'c':
        ...
        radioBtnStyle=( 'QRadioButton::indicator::checked               {color:blue;border: 0px solid '+ self.lighterColor(self.bgColor,times=4)+';border-radius: '+bordRad+';background-color: '+data[0][0]+';}'
                        'QRadioButton::indicator::checked:hover         {background-color: '+data[0][1]+';}'
                        'QRadioButton::indicator::checked:pressed       {background-color: '+data[0][2]+';}'
                        'QRadioButton::indicator::unchecked             {border:'+bordWid+' solid '+ self.lighterColor(self.bgColor,times=4)+';border-radius: '+bordRad+';background-color: '+data[1][0]+';}'
                        'QRadioButton::indicator::unchecked::hover      {background-color: '+data[1][1]+';}'
                        'QRadioButton::indicator::unchecked::pressed    {background-color: '+data[1][2]+';}')
        return radioBtnStyle


    def toolBtnStyle(self,kw='a',lang='e',bordRad='5px',bordWid='1px'):
        font=''
        if lang == 'e':
            font='Verdana'
        elif lang == 'c':
            font='Microsoft YaHei'  
        if kw=='b':
            toolBtnStyle=('QToolButton{background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #5B5F5F, stop: 0.5 #0C2436,stop: 1.0 #27405A); border-style: outset; border-width: 1px; border-radius: 5px; border-color: #11223F; padding: 1px; }   '
        ...
        toolBtnStyle=(  'QToolButton            {color:'+self.fontWhite+';background: transparent; border-style: outset; border-width: 0px; border-radius: 5px; border-color: rgb(78,78,78); padding: 1px; }   '
