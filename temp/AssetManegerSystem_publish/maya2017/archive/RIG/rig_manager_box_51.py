...
class assetManager_RigBoxUI(QtWidgets.QDialog, MayaQWidgetDockableMixin, chooseIcon):
    ...
    def createGeneralPage(self):
        ...
        labModLow = QtWidgets.QLabel('Serve-L  : ', msgWid)
        ...
        labModLow = QtWidgets.QLabel('Local_L  : ', msgWid)
        labModLow.setStyleSheet(Mstyle.QLabel(fontSize='10px', kw='b'))
        ...
        modGHB44 = QtWidgets.QHBoxLayout()
        lowupBtn = QtWidgets.QPushButton('update')
        lowupBtn.setStyleSheet(Mstyle.QPushButton(bordRad='8px'))
        lowupBtn.setToolTip('lowUpdate')
        lowreBtn = QtWidgets.QPushButton('refrence')
    ...
    def oprbtn_openUploadFn(self):
        ...
        self.rigUp.getNotifyFromTxt(self.initPath + '\\maya\\RIG\\notify.txt')
        self.rigUp.createUI()
        self.rigUp.Op_Ui()
...
#RigManaBUI=assetManager_RigBoxUI()
#RigManaBUI.Op_Ui()
# RigManaBUI.raise_()
