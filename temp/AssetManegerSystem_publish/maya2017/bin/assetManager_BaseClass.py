...
import sys, os, time, json, shutil, sqlite3, random, getpass, datetime, random
...
class assetManager_BaseClass(QtWidgets.QDialog, assetManager_HTML):
    titleName = ''
    widgetHeight = 750
    widgetWidth = 600
    initPath = ''
    ...
    def createTitleBar(self):
        ...
        self.fileMn = QtWidgets.QMenu(self.keepLogin, self.MainMenuBar)
        ...
        self.projectMn = QtWidgets.QMenu('project List', self.MainMenuBar)
        self.MainMenuBar.addMenu(self.projectMn)

        self.projectActionGrp = QtWidgets.QActionGroup(self)
        ...
        shMn = QtWidgets.QMenu('Layout', self.MainMenuBar)
        ...
        aboutMn = QtWidgets.QMenu('About', self.MainMenuBar)
    ...
    def projectChangeFn(self,theAct):
        ...
        ans = QtWidgets.QMessageBox.information( self, "project Changed",
                                                  ('project changed to ' + str(theAct.text()) + '\nplease restart toolkit'),
                                                 QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No)
        if QtWidgets.QMessageBox.Yes == ans:
