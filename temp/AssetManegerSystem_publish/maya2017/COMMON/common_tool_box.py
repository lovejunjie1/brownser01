...
class chooseIconByUserUI(QtWidgets.QMainWindow):
    ...
    def CreateUI(self):
        ...
        mian = QtWidgets.QWidget(self)
        mian.resize(self.x, self.y)
        # close Btn Set
        Xbtn = QtWidgets.QPushButton('x', mian)
        ...
        # TitleLabel
        TitleLab = QtWidgets.QLabel(self.UITitle, mian)
        ...
        # cha sel
        mainGrp = QtWidgets.QGroupBox('Pick Icon', mian)
        ...
        for count, f in enumerate(files):
            ...
            Btn.setIcon(QtWidgets.QIcon(combiePath))
...
class chooseIcon(QtCore.QObject):
    # class figoIcon(QtWidgets.QIcon):
    # initPath = ''
    def chooseIcon(self, inputStr, isAuto=True, isDef=False, isBaseRoot=False):
        ...
        if isBaseRoot:
            returnIcon = QtWidgets.QIcon(self.iconPath + '\\toolBoxUI\\' + inputStr)

        elif isDef:
            iconPath = self.iconPath + '\\toolBoxUI\\definedIcon\\' + inputStr + '.png'
            returnIcon = QtWidgets.QIcon(iconPath)
            ...
            returnIcon = QtWidgets.QIcon(self.iconPath + '\\toolBoxUI\\' + files[cnt])
        return returnIcon


class dragToolListWidget(QtWidgets.QListWidget):
    mainSize = 0
    onPress = False
    iArray = []
    isDrag = False
    ...
    def createContextMenu(self):
        ...
        actionA = self.contextMenu.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'run')
        self.actionB = self.contextMenu.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'open')
        self.actionC = self.contextMenu.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'history')
        # add sub menu
        self.second = self.contextMenu.addMenu(QtWidgets.QIcon(self.iconPath + "floder.png"), u"more")
        # self.second.setMask(mask)
        self.actionD = self.second.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'actionA')
        self.actionE = self.second.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'actionB')
        self.actionF = self.second.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'actionC')
        self.actionF = self.second.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'actionD')
...
class dragToolListItem(QtWidgets.QListWidgetItem):
...
class dragToolButton(QtWidgets.QToolButton, chooseIcon):
    # initPath inhert by parent
    pageName = ''
    ...
    def createContextMenu(self):
        ...
        self.contextMenu = QtWidgets.QMenu(self)
        self.contextMenu.setStyleSheet(Mstyle.QMenu())
        self.actionA = self.contextMenu.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'run')
        self.actionB = self.contextMenu.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'open')
        self.actionC = self.contextMenu.addAction(QtWidgets.QIcon(self.iconPath + "more.png"), u'history')
        # add sub menu
        self.second = self.contextMenu.addMenu(QtWidgets.QIcon(self.iconPath + "floder.png"), u"more")
...
class detailGroupBox(QtWidgets.QGroupBox, chooseIcon):
    fileName = ''
    jsonPath = ''
    iconPath = ''
    pName = ''
    ...
    def __init__(self, parent=None):
        ...
        self.sLabel0 = QtWidgets.QLabel(self)
        self.sLabel1 = QtWidgets.QLabel(self)
        self.sBtn1 = QtWidgets.QToolButton(self)
        self.sBtn2 = QtWidgets.QToolButton(self)
        self.sBtn3 = QtWidgets.QToolButton(self)
        self.sBtn4 = QtWidgets.QToolButton(self)
        self.sBtn5 = QtWidgets.QToolButton(self)
        self.sBtn6 = QtWidgets.QToolButton(self)
        self.dataEdit = QtWidgets.QTextEdit(self)
    ...
    def CreateUI(self):
        ...
        self.Btn.setIcon(QtWidgets.QIcon(self.chooseIcon('r')))
        ...
        self.sBtn1.setIcon(QtWidgets.QIcon(self.chooseIcon('lock', isDef=True)))
        ...
        self.sBtn2.setIcon(QtWidgets.QIcon(self.chooseIcon('save', isDef=True)))
        ...
        self.sBtn3.setIcon(QtWidgets.QIcon(self.chooseIcon('clock', isDef=True)))
        ...
        self.sBtn4.setIcon(QtWidgets.QIcon(self.chooseIcon('chinese', isDef=True)))
        ...
        self.sBtn5.setIcon(QtWidgets.QIcon(self.chooseIcon('english', isDef=True)))
        ...
        self.sBtn6.setIcon(QtWidgets.QIcon(self.chooseIcon('korea', isDef=True)))
    ...
    def setDetailIcon(self, theIconPath):
        self.Btn.setIcon(QtWidgets.QIcon(
...
class MDtoolBoxUI(MayaQWidgetDockableMixin, QtWidgets.QDialog, chooseIcon):
    ...
    def createForm(self):
        ...
        fileMn = QtWidgets.QMenu('file', qmb)
        qmb.addMenu(fileMn)

        fileMn1act = fileMn.addAction('change Detail Icon')
        fileMn.addSeparator()  # --------------------
        # fileMn2 = QtWidgets.QMenu('change department', qmb)
        fileMn2 = QtWidgets.QMenu('change department', qmb)
        ...
        shMn = QtWidgets.QMenu('show/hide', qmb)
        qmb.addMenu(shMn)
        ...
        self.searchGb = QtWidgets.QWidget(self)
        self.searchGb.setFixedSize(self.widgetWidth * 0.98, 50)
        self.searchGb.setGeometry(5, 135, 5, 5)
        searchLy = QtWidgets.QHBoxLayout(self)

        searchLab = QtWidgets.QLabel('search : ', self)
        searchLy.addWidget(searchLab)
        self.LE = QtWidgets.QLineEdit('', self)
        self.LE.setStyleSheet(Mstyle.QLineEdit(kw='c', lang='c'))
        searchLy.addWidget(self.LE)

        s1Mn = QtWidgets.QMenu()
        s1Mnact1 = QtWidgets.QAction('List Form', s1Mn)
        s1Mn.addAction(s1Mnact1)
        s1Mnact2 = QtWidgets.QAction('Block Form', s1Mn)
        s1Mn.addAction(s1Mnact2)

        searchBtn1 = QtWidgets.QToolButton(self)
        ...
        self.searchBtn2 = QtWidgets.QToolButton(self)
        ...
        searchBtn3 = QtWidgets.QToolButton(self)
        ...
        sortMn = QtWidgets.QMenu()
        sortMnact1 = QtWidgets.QAction('Time +', sortMn)
        sortMn.addAction(sortMnact1)
        sortMnact2 = QtWidgets.QAction('Time -', sortMn)
        sortMn.addAction(sortMnact2)
        sortMn.addSeparator()
        # --------------------
        sortMnact3 = QtWidgets.QAction('Name +', sortMn)
        sortMn.addAction(sortMnact3)
        sortMnact4 = QtWidgets.QAction('Name -', sortMn)
        sortMn.addAction(sortMnact4)

        searchBtn4 = QtWidgets.QToolButton(self)
    ...
    def about1actFn(self):
        QtWidgets.QMessageBox.information(self, "Author", ('Auther: figo\nE-mail: 276415977@qq.com'),
                                      QtWidgets.QMessageBox.Yes, QtWidgets.QMessageBox.Yes)

    def about2actFn(self):
        QtWidgets.QMessageBox.information(self, "help", (r'Z:\temp\figo\help\how to use tool box.mp4'),
                                      QtWidgets.QMessageBox.Yes, QtWidgets.QMessageBox.Yes)
    ...
    def LEtextChangedFn(self):
        ...
        cwd = self.QTwidget.widget(Idx)
        if type(cwd) == QtWidgets.QScrollArea:
            cc = cwd.widget()
            if cc.toolTip() == 'block':
                cwd = cc
