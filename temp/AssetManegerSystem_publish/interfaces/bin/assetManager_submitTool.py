...
class assetManager_submitTool(qw.QWidget):
    ...
    def createUI(self):
        ...
        # -----TitleLabel-----------------------
        TitleLab = qw.QLabel('Submit', self)
        ...
        self.groupBoxA = qw.QGroupBox(groupBoxAMsg, self)
        grpVbox = qw.QVBoxLayout()
        ...
        warningLab = qw.QLabel(warningLabMsg, self.groupBoxA)
        ...
        self.BtnA1 = qw.QPushButton(BtnA1Msg, self)
        ...
        self.BtnA2 = qw.QPushButton(BtnA2Msg, self)
        ...
        self.checkLab = qw.QLabel(checkLabTitle, self)
        self.checkLab.setFixedHeight(20)
        self.checkLab.setFixedWidth(130)

        line3HBox = qw.QHBoxLayout()
    ...
    def saveScenceImage(self, path, isFront=True):
        ...
        reply = qw.QMessageBox.information(self,
                                              "confirm",
    ...
    def doSomething(self, event):
        ...
        if event.button() == QtCore.Qt.MiddleButton:
            ...
            self.sceenRtn ,filetype = qw.QFileDialog.getOpenFileName(self, "select Picture", "D:/","PNG file (*.png);;Jpeg Files (*.jpg);;Jpeg Files (*.jpeg)")
        if event.button() == QtCore.Qt.RightButton or event.button() == QtCore.Qt.LeftButton or event.button() == QtCore.Qt.MiddleButton:
            if self.sceenRtn:
...
if __name__ == '__main__':
    ...
    cleanUIRT.getNotifyFromTxt(r'D:\AssetManegerSystem_publish\maya2016\RIG\notify.txt')
    cleanUIRT.createUI()
    cleanUIRT.Op_Ui()
