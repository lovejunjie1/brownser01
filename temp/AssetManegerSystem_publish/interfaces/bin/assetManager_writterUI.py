...
from interfaces.bin.ext.find import docWritter_Find
from interfaces.bin.ext.datetime import docWritter_DateTime
from interfaces.bin.ext.table import docWritter_Table
from interfaces.bin.ext.wordcount import docWritter_WordCount

class FTextEdit(qw.QTextEdit):
    copySignal = QtCore.Signal(str)

    def keyPressEvent(self, e):
        if (e.type() == QtCore.QEvent.KeyPress):
            if e.matches(qw.QKeySequence.Paste):
                self.copySignal.emit('copy')
        super(FTextEdit, self).keyPressEvent(e)


class assetManager_writterUI(qw.QMainWindow):
    ...
    def initToolbar(self):
        ...
        self.newAction = qw.QAction(QtGui.QIcon(self.initPath + "new.png"), "New", self)
        self.newAction.setShortcut("Ctrl+N")
        self.newAction.setStatusTip("Create a new document from scratch.")
        self.newAction.triggered.connect(self.new)

        self.openAction = qw.QAction(QtGui.QIcon(self.initPath + "open.png"), "Open file", self)
        self.openAction.setStatusTip("Open existing document")
        self.openAction.setShortcut("Ctrl+O")
        self.openAction.triggered.connect(self.open)

        self.saveAction = qw.QAction(QtGui.QIcon(self.initPath + "save.png"), "Save", self)
        self.saveAction.setStatusTip("Save document")
        self.saveAction.setShortcut("Ctrl+S")
        self.saveAction.triggered.connect(self.save)

        self.saveasAction = qw.QAction(QtGui.QIcon(self.initPath + "save.png"), "Save as ...", self)
        self.saveasAction.setStatusTip("Save document as ...")
        self.saveasAction.setShortcut("Ctrl+SHIFT+S")
        self.saveasAction.triggered.connect(self.saveas)

        self.cutImageAction = qw.QAction(QtGui.QIcon(self.initPath + "print.png"), "Cut Image", self)
        ...
        self.previewAction = qw.QAction(QtGui.QIcon(self.initPath + "preview.png"), "Page view", self)
        self.previewAction.setStatusTip("Preview page before printing")
        self.previewAction.setShortcut("Ctrl+Shift+P")
        self.previewAction.triggered.connect(self.preview)

        self.closeAction = qw.QAction(QtGui.QIcon(self.initPath + "cross.png"), "Close Widget", self)
        ...
        self.findAction = qw.QAction(QtGui.QIcon(self.initPath + "find.png"), "Find and replace", self)
        self.findAction.setStatusTip("Find and replace words in your document")
        self.findAction.setShortcut("Ctrl+F")
        self.findAction.triggered.connect(docWritter_Find(self).show)

        self.cutAction = qw.QAction(QtGui.QIcon(self.initPath + "cut.png"), "Cut to clipboard", self)
        self.cutAction.setStatusTip("Delete and copy text to clipboard")
        self.cutAction.setShortcut("Ctrl+X")
        self.cutAction.triggered.connect(self.text.cut)

        self.copyAction = qw.QAction(QtGui.QIcon(self.initPath + "copy.png"), "Copy to clipboard", self)
        self.copyAction.setStatusTip("Copy text to clipboard")
        self.copyAction.setShortcut("Ctrl+C")
        self.copyAction.triggered.connect(self.text.copy)

        self.pasteAction = qw.QAction(QtGui.QIcon(self.initPath + "paste.png"), "Paste from clipboard", self)
        self.pasteAction.setStatusTip("Paste text from clipboard")
        self.pasteAction.setShortcut("Ctrl+V")
        self.pasteAction.triggered.connect(self.pasteFn)

        self.undoAction = qw.QAction(QtGui.QIcon(self.initPath + "undo.png"), "Undo last action", self)
        self.undoAction.setStatusTip("Undo last action")
        self.undoAction.setShortcut("Ctrl+Z")
        self.undoAction.triggered.connect(self.text.undo)

        self.redoAction = qw.QAction(QtGui.QIcon(self.initPath + "redo.png"), "Redo last undone thing", self)
        self.redoAction.setStatusTip("Redo last undone thing")
        self.redoAction.setShortcut("Ctrl+Y")
        self.redoAction.triggered.connect(self.text.redo)

        dateTimeAction = qw.QAction(QtGui.QIcon(self.initPath + "calender.png"), "Insert current date/time", self)
        dateTimeAction.setStatusTip("Insert current date/time")
        dateTimeAction.setShortcut("Ctrl+D")
        # dateTimeAction.triggered.connect(datetime.DateTime(self).show)

        wordCountAction = qw.QAction(QtGui.QIcon(self.initPath + "count.png"), "See word/symbol count", self)
        wordCountAction.setStatusTip("See word/symbol count")
        wordCountAction.setShortcut("Ctrl+W")
        wordCountAction.triggered.connect(self.wordCount)

        tableAction = qw.QAction(QtGui.QIcon(self.initPath + "table.png"), "Insert table", self)
        tableAction.setStatusTip("Insert table")
        tableAction.setShortcut("Ctrl+T")
        tableAction.triggered.connect(docWritter_Table(self).show)

        imageAction = qw.QAction(QtGui.QIcon(self.initPath + "image.png"), "Insert image", self)
        imageAction.setStatusTip("Insert image")
        imageAction.setShortcut("Ctrl+Shift+I")
        imageAction.triggered.connect(self.insertImage)

        bulletAction = qw.QAction(QtGui.QIcon(self.initPath + "bullet.png"), "Insert bullet List", self)
        bulletAction.setStatusTip("Insert bullet list")
        bulletAction.setShortcut("Ctrl+Shift+B")
        bulletAction.triggered.connect(self.bulletList)

        numberedAction = qw.QAction(QtGui.QIcon(self.initPath + "number.png"), "Insert numbered List", self)
    ...
    def initFormatbar(self):
        ...
        fontColor = qw.QAction(QtGui.QIcon(self.initPath + "font-color.png"), "Change font color", self)
        fontColor.triggered.connect(self.fontColorChanged)

        boldAction = qw.QAction(QtGui.QIcon(self.initPath + "bold.png"), "Bold", self)
        boldAction.triggered.connect(self.bold)

        italicAction = qw.QAction(QtGui.QIcon(self.initPath + "italic.png"), "Italic", self)
        italicAction.triggered.connect(self.italic)

        underlAction = qw.QAction(QtGui.QIcon(self.initPath + "underline.png"), "Underline", self)
        underlAction.triggered.connect(self.underline)

        strikeAction = qw.QAction(QtGui.QIcon(self.initPath + "strike.png"), "Strike-out", self)
        strikeAction.triggered.connect(self.strike)

        superAction = qw.QAction(QtGui.QIcon(self.initPath + "superscript.png"), "Superscript", self)
        superAction.triggered.connect(self.superScript)

        subAction = qw.QAction(QtGui.QIcon(self.initPath + "subscript.png"), "Subscript", self)
        subAction.triggered.connect(self.subScript)

        alignLeft = qw.QAction(QtGui.QIcon(self.initPath + "align-left.png"), "Align left", self)
        alignLeft.triggered.connect(self.alignLeft)

        alignCenter = qw.QAction(QtGui.QIcon(self.initPath + "align-center.png"), "Align center", self)
        alignCenter.triggered.connect(self.alignCenter)

        alignRight = qw.QAction(QtGui.QIcon(self.initPath + "align-right.png"), "Align right", self)
        alignRight.triggered.connect(self.alignRight)

        alignJustify = qw.QAction(QtGui.QIcon(self.initPath + "align-justify.png"), "Align justify", self)
        alignJustify.triggered.connect(self.alignJustify)

        indentAction = qw.QAction(QtGui.QIcon(self.initPath + "indent.png"), "Indent Area", self)
        indentAction.setShortcut("Ctrl+Tab")
        indentAction.triggered.connect(self.indent)

        dedentAction = qw.QAction(QtGui.QIcon(self.initPath + "dedent.png"), "Dedent Area", self)
        dedentAction.setShortcut("Shift+Tab")
        dedentAction.triggered.connect(self.dedent)

        backColor = qw.QAction(QtGui.QIcon(self.initPath + "highlight.png"), "Change background color", self)
    ...
    def initMenubar(self):
        ...
        toolbarAction = qw.QAction("Toggle Toolbar", self)
        toolbarAction.triggered.connect(self.toggleToolbar)

        formatbarAction = qw.QAction("Toggle Formatbar", self)
        formatbarAction.triggered.connect(self.toggleFormatbar)

        statusbarAction = qw.QAction("Toggle Statusbar", self)
    ...
    def closeEvent(self, event):
        ...
        if self.changesSaved:
            ...
            popup = qw.QMessageBox(self)

            popup.setIcon(qw.QMessageBox.Warning)

            popup.setText("The document has been modified")

            popup.setInformativeText("Do you want to save your changes?")

            popup.setStandardButtons(qw.QMessageBox.Save |
                                     qw.QMessageBox.Cancel |
                                     qw.QMessageBox.Discard)

            popup.setDefaultButton(qw.QMessageBox.Save)

            answer = popup.exec_()

            if answer == qw.QMessageBox.Save:
                self.save()

            elif answer == qw.QMessageBox.Discard:
                event.accept()
    ...
    def pasteFn(self):
        self.clipboard = qw.QApplication.clipboard()
    ...
    def context(self, pos):
        ...
        if table:
            ...
            appendRowAction = qw.QAction("Append row", self)
            appendRowAction.triggered.connect(lambda: table.appendRows(1))

            appendColAction = qw.QAction("Append column", self)
            appendColAction.triggered.connect(lambda: table.appendColumns(1))

            removeRowAction = qw.QAction("Remove row", self)
            removeRowAction.triggered.connect(self.removeRow)

            removeColAction = qw.QAction("Remove column", self)
            removeColAction.triggered.connect(self.removeCol)

            insertRowAction = qw.QAction("Insert row", self)
            insertRowAction.triggered.connect(self.insertRow)

            insertColAction = qw.QAction("Insert column", self)
            insertColAction.triggered.connect(self.insertCol)

            mergeAction = qw.QAction("Merge cells", self)
            ...
            splitAction = qw.QAction("Split cells", self)
            ...
            event = qw.QContextMenuEvent(qw.QContextMenuEvent.Mouse, QtCore.QPoint())
    ...
    def open(self):
        ...
        self.filename = qw.QFileDialog.getOpenFileName(self, 'Open File', ".", "(*.writer)")[0]
    ...
    def saveas(self):
        ...
        if not self.filename:
            self.filename = qw.QFileDialog.getSaveFileName(self, 'Save as')[0]
    ...
    def preview(self):
        ...
        # Open preview dialog
        preview = qw.QPrintPreviewDialog()
    ...
    def cutImage(self):
        notRun = True
        runPath = (getAssetManagerPath()['main'] + '\\maya2016\\bin\\PrScrn.dll')
    ...
    def insertImage(self):
        ...
        # Get image file name
        filename = \
        qw.QFileDialog.getOpenFileName(self, 'Insert image', ".", "Images (*.png *.xpm *.jpg *.bmp *.gif)")[0]
        print filename
        if filename:
            ...
            if image.isNull():
                ...
                popup = qw.QMessageBox(qw.QMessageBox.Critical,
                                          "Image load error",
    ...
    def bold(self):
        ...
        if self.text.fontWeight() == qw.QFont.Bold:

            self.text.setFontWeight(qw.QFont.Normal)

        else:

            self.text.setFontWeight(qw.QFont.Bold)
    ...
    def superScript(self):
        ...
        # Toggle the state
        if align == qw.QTextCharFormat.AlignNormal:

            fmt.setVerticalAlignment(qw.QTextCharFormat.AlignSuperScript)

        else:

            fmt.setVerticalAlignment(qw.QTextCharFormat.AlignNormal)
    ...
    def subScript(self):
        ...
        if align == qw.QTextCharFormat.AlignNormal:
            ...
            fmt.setVerticalAlignment(qw.QTextCharFormat.AlignSubScript)
    ...
    def indent(self):
        ...
        if cursor.hasSelection():
            ...
            direction = qw.QTextCursor.Up if diff > 0 else qw.QTextCursor.Down

            # Iterate over lines (diff absolute value)
            for n in range(abs(diff) + 1):
                # Move to start of each line
                cursor.movePosition(qw.QTextCursor.StartOfLine)
    ...
    def bulletList(self):
        ...
        cursor.insertList(qw.QTextListFormat.ListDisc)
    ...
    def numberList(self):
        ...
        cursor.insertList(qw.QTextListFormat.ListDecimal)
