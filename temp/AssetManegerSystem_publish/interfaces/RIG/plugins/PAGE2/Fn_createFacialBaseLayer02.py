...
createMuscleChain('r_cheek','mainCtrl')#r_cheek

createMuscleChain('l_cheek','mainCtrl')#l_cheek 

createMuscleChain('r_chin','mainCtrl')#r_puffer

createMuscleChain('l_chin','mainCtrl')#l_puffer

createMuscleChain('r_brow','mainCtrl')#r_brow

createMuscleChain('l_brow','mainCtrl')#l_brow

createMuscleChain('m_brow','mainCtrl')#c_brow

createMuscleChain('m_nose','mainCtrl',1)#c_nose 

createMuscleChain('r_uplipIn','mainCtrl') #r_uplipIn

createMuscleChain('l_uplipIn','mainCtrl') #l_uplipIn

createMuscleChain('r_downlipIn','mainCtrl') #r_downlipIn

createMuscleChain('l_downlipIn','mainCtrl') #l_downlipIn

createMuscleChain('r_uplipMiddle','mainCtrl')  #r_uplipMiddle

createMuscleChain('l_uplipMiddle','mainCtrl')  #l_uplipMiddle

createMuscleChain('r_downlipMiddle','mainCtrl')  #r_downlipMiddle

createMuscleChain('l_downlipMiddle','mainCtrl')  #l_downlipMiddle

createMuscleChain('r_uplipOut','mainCtrl') #r_uplipOut

createMuscleChain('l_uplipOut','mainCtrl') #l_uplipOut

createMuscleChain('r_downlipOut','mainCtrl') #r_downlipOut

createMuscleChain('l_downlipOut','mainCtrl') #l_downlipOut

createMuscleChain('r_orbicularis','mainCtrl') #r_orbicularis

createMuscleChain('l_orbicularis','mainCtrl') #l_orbicularis

createMuscleChain('r_Caninus','mainCtrl') #r_Caninus

createMuscleChain('l_Caninus','mainCtrl') #l_Caninus

createMuscleChain('r_upeyeOut','mainCtrl') #r_upeye_03

createMuscleChain('l_upeyeOut','mainCtrl') #l_upeye_03

createMuscleChain('r_downeyeOut','mainCtrl') #r_downeye_03

createMuscleChain('l_downeyeOut','mainCtrl') #l_downeye_03

createMuscleChain('r_upeyeMiddle','mainCtrl') #r_upeye_02

createMuscleChain('l_upeyeMiddle','mainCtrl') #l_upeye_02

createMuscleChain('r_downeyeMiddle','mainCtrl') #r_downeye_02

createMuscleChain('l_downeyeMiddle','mainCtrl') #l_downeye_02

createMuscleChain('r_upeyeIn','mainCtrl') #r_upeye_01

createMuscleChain('l_upeyeIn','mainCtrl') #l_upeye_01

createMuscleChain('r_downeyeIn','mainCtrl') #r_downeye_01

createMuscleChain('l_downeyeIn','mainCtrl') #l_downeye_01
#create skin joints
mirrorPositionLoc()
#mirror positions
locators=cmds.ls('*_positionLoc')
for i in locators:
    createSingleCtrl(i)
#create ctrl and joint,base on 'positionLoc'
