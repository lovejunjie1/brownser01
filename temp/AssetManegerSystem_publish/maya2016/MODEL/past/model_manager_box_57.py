...
class assetManager_ModelBoxUI(QtGui.QDialog, MayaQWidgetDockableMixin, chooseIcon):
    ...
    def confirmFn(self, list):
        ...
        try:
            ...
            print 'start date not logged.can not confirm.'
            return False
        spSD = sDate.split(' ')
...
#ModelManaBUI=assetManager_ModelBoxUI()
#ModelManaBUI.Op_Ui()
