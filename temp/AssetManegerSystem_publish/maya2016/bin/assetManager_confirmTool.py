...
class assetManager_confirmTool(QtGui.QMainWindow):
    ...
    def createUI(self):
        ...
        self.highTool = QtGui.QPushButton('high')
        ...
        self.lowTool = QtGui.QPushButton('low')
        ...
        msgGrp = QtGui.QGroupBox('Message:')
