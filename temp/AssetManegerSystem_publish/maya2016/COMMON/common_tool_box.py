...
class MDtoolBoxUI(MayaQWidgetDockableMixin, QtGui.QDialog, chooseIcon):
    ...
    def createForm(self):
        ...
        fileMn.addSeparator()  # --------------------
        # fileMn2 = QtGui.QMenu('change department', qmb)
        fileMn2 = QtGui.QMenu('change department', qmb)
    ...
    def about2actFn(self):
        QtGui.QMessageBox.information(self, "help", (r'Z:\temp\figo\help\how to use tool box.mp4'),
                                      QtGui.QMessageBox.Yes, QtGui.QMessageBox.Yes)
    ...
    def createPage(self, floderName, spacing=3, sort='nameF'):
        ...
        epScroll = QtGui.QScrollArea(self)
