...
"QsearchLine[readOnly=\"true\"]{ background-color: gray }"))
        ...
        self.webColPage = spoilerItem.FrameLayout(title="Unit History")
        # 这就是折叠页，自己写的
        ...
        self.fileColPage = spoilerItem.FrameLayout(title="File Struct")
        self.fileColPage.addWidget(qw.QLabel('fileStruct sheet'))
        self.verticalLayout_3.addWidget(self.fileColPage)

        self.actionColPage = spoilerItem.FrameLayout(title="actions",switch=True)
        self.actionColPage.addWidget(qw.QLabel('actionsA'))
        self.actionColPage.addWidget(qw.QLabel('actionsB'))
        self.verticalLayout_3.addWidget(self.actionColPage)


        self.eventColPage = spoilerItem.FrameLayout(title="events")
